...
race_tbl <- bind_rows(type_01_tbl, type_02_tbl) %>% 
  ...
  mutate(시도 = factor(시도, levels = c("대전충남", "세종충북", "대구경북", "강원", "1차 슈퍼데이", "광주전남", "전북", "제주", "부울경", "인천", "2차 슈퍼데이", "경기"))) %>% 
...
test_that("엑셀 데이터 정합성", {
  ...
  expect_equal(total_sum, 1089497)
})


sido_fct <- c("대전충남", "세종충북", "대구경북", "강원", "광주전남", "전북", "제주", "부울경", "인천", "경기")
report_day <- "10월 9일"
file_date <- "20211009"
```
