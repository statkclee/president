...
# 시군구 [^rmarkdown-dt] {#table-sigungu}
...
sigungu_sd <- SharedData$new(presid_17_sigungu_tbl, key = ~시도명)

# Use SharedData like a dataframe with Crosstalk-enabled widgets
bscols(
  # Create a filter input
  crosstalk::filter_select("sido", "시도", sigungu_sd, group = ~시도명, multiple = FALSE),
  crosstalk::filter_select("sido", "시군구명", sigungu_sd, group = ~구시군명, multiple = FALSE),
