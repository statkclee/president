...
choongnam_doc <- read_docx("data/minju_race/210904_대전충남제20대_대선_후보자_선출_위한_결과_보도자료.docx")
...
```{r minju-충북}
choongbook_doc <- read_docx("data/minju_race/210905_(세종충북)_제20대_대선_후보자_선출_위한_결과_보도자료_fn.docx")
...
```{r minju-경북}
kyungbook_doc <- read_docx("data/minju_race/210911_대구경북_제20대_대선_후보자_선출_위한_결과_보도자료.docx")
...
```{r minju-강원}
kangwon_doc <- read_docx("data/minju_race/210912_제20대_대선후보자_선출_위한_순회경선_결과_보도자료(강원)_fn.docx")
...
choongbook_tbl <- read_rds("data/minju_race/choongbook_tbl.rds")
