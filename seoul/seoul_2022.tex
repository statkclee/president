...
\hypersetup{
  pdftitle={A Sample Title - 한글 사랑},
  pdfauthor={한글 Doe; Eva Nováková; Matti Meikäläinen; Ashok Kumar},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A Sample Title - 한글 사랑}
\usepackage{etoolbox}
\makeatletter
...
documentation.}
\author{한글 Doe \and Eva Nováková \and Matti Meikäläinen \and Ashok
Kumar}
\date{}
...
\includegraphics[width=\paperwidth, keepaspectratio]{\_extensions/nmfs-opensci/titlepage/images/TheGreatWaveoffKanagawa.jpeg}};
...
% Title and subtitle
{{\large{\bfseries{\nohyphens{A Sample Title - 한글 사랑}}}}\par
}%
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, boxrule=0pt, interior hidden, enhanced, frame hidden, breakable]}{\end{tcolorbox}}\fi
...
\listoftables
\mainmatter
\hypertarget{uxd55cuxae00}{%
\section{한글\ldots{}}\label{uxd55cuxae00}}
